...
class RemoteActivity : AppCompatActivity(), OnDayPickedListener {
    ...
    private lateinit var remoteCalendarEvents: RemoteCalendarEvents
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        titleTextView.text = "Remote Events"
        ...
        fastAdapter.addEventHook(object : ClickEventHook<EventItem>() {
            ...
            override fun onClick(
                ...
                if (!item.sources.isNullOrEmpty())
                    customTabsIntent.launchUrl(this@RemoteActivity, Uri.parse(item.sources[0]))
                else
                    Toast.makeText(
                        this@RemoteActivity,
                        "Source url not set",
